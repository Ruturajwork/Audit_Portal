...
const CustomerProjectV2QuestionSceen = () => {
        ...
        <Container component="main" maxWidth="xs">
          ...
          <Box sx={style}>
            <TableContainer sx={{ maxHeight: 540 }}>
              ...
              <Typography component="h1" variant="h5">
                Result and Observation : {data1.version2[index].questions.resultAndObservation}.
              </Typography>
              <Typography component="h1" variant="h5">
                Recomendation: {data1.version2[index].questions.recomendation}.
              </Typography>
              <Typography component="h1" variant="h5">
                Auditor Rating: {data1.version2[index].questions.auditorRating}.
              </Typography>
              {/* <Typography component="h1" variant="h5">
                Proof: .
              </Typography> */}
              <img src={data1.version2[index].questions.proof} alt={data1.version2[index].questions.proof} />
                ...
                <Grid container sx={{ marginTop: 4 }}>
                  <Grid item xs={20}>
                    <TextField
                      ...
                      multiline
                      size="small"
                      //  defaultValue={project.version2[index].questions.resultAndObservation}
...
export default CustomerProjectV2QuestionSceen;
